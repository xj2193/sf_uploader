SELECT [Id]
      ...
      ,[HP_gROR_Consent_Status__c]
      ,[HP_gROR_Consent_Date__c]
      ,[HP_COPE_May_PPI_Survey_Completion_Date__c]
      ,[HP_COPE_June_PPI_Survey_Completion_Date__c]
      ,[HP_COPE_July_PPI_Survey_Completion_Date__c]
  FROM [aou_sf].[dbo].[sf_journey_update_json]
  WHERE [HP_Withdrawal_Status__c] = 1